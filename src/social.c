...
void social_desenhar(Uint32 agora){(void)agora;gfx_cor((GfxRect){0,0,NV_TELA_W,NV_TELA_H},0,NV_COR_FUNDO_R,NV_COR_FUNDO_G,NV_COR_FUNDO_B,1);texto(TXT_CAPTION,"ENTRE AMIGOS",96,56,550,179);
  ...
  texto(TXT_CAPTION,"Perfil",96,900,480,179);texto(TXT_CAPTION,"← Voltar",96,970,480,235);texto(TXT_TITULO3,"Atividade recente",656,64,1150,245);texto(TXT_CAPTION,"Pessoa · ação · título · horário",656,122,1150,179);
